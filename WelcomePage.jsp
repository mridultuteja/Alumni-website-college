                  ...
                  <div class="rd-navbar-top-panel-right-part">
                    <div class="rd-navbar-top-panel-left-part">
                      <div class="unit unit-horizontal unit-middle unit-spacing-xs">
                        ...
                        <div class="unit-body"><a href="./login-register.jsp">Logout</a></div>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div class="shell section-30 section-sm-top-70 section-sm-bottom-60">
          <div class="offset-sm-top-35">
            <ul class="list-inline list-inline-lg list-inline-dashed p">
              <li><a href="./WelcomePage.jsp#">Welcome To This Page</a></li>
...
<h2 align="center"> WELCOME ALUMNI</h2> <br>
<br> <br> <br> 
<div style= "color:black">

<form action="WelcomeServlet" method="post">

<input type="submit" name="View Directory" value="View Directory" >
</form>
<br><br><br><br>
<div>
...
<table class="table table-bordered"
									style="width: 100%; font-size: 0.9em;">
													...
													<tbody>
														...
														<%-- commented for non hibernate <%-- <fmt:parseDate value="${data.startDate}" pattern="yyyy-MM-dd" var="stDate"/>	
														<fmt:parseDate value="${data.endDate}" pattern="yyyy-MM-dd" var="enDate"/> --%> 	
															<tr>
											     				<td><c:out value="${data.fname}" escapeXml="false" /></td>
																<td><c:out value="${data.lname}" escapeXml="false" /></td>
																
																<td><c:out value="${data.username}" escapeXml="false" />
			
																</td>
																
																<td><c:out value="${data.password}" escapeXml="false" />
																
																</td>
																
																<td><c:out value="${data.email}" escapeXml="false" /></td>
...
<img class="olark-image-modal" src="./WelcomePage.jsp" data-reactid=".0.4.1.0"></span>
</div></div></div>
<!-- Google Tag Manager -->
