                  ...
                  <div class="rd-navbar-mobile-scroll">
                    ...
                    <div id="rd-navbar-search-mobile" class="rd-navbar-search-mobile">
                      <form action="./search-results.html" method="GET" class="rd-navbar-search-form search-form-icon-right rd-search">
                        ...
                        <button type="submit" class="icon fa-search rd-navbar-search-button"><img src="images/search_icon.jpg"></button>
                      </form>
                    </div>
                  </div>
                </div>
...
<div style="color:black; align:left"> <br> <br>
...
Email Id:&nbsp;<input type="email" placeholder="your email" name="email"> <br> <br>
Phone No &nbsp; &nbsp; 
					   Mob:&nbsp; <input type="text"> &nbsp; &nbsp;<br> <br>
					   Home:&nbsp;<input type="text"> <br> <br>

Birth Date:&nbsp; <input type="date" name="bday" placeholder="dd/mm/yy"> <br><br>
Username:&nbsp;<input type="text" name="un"> <br> <br>
Password:&nbsp;<input type="password" name="pw" id="pw1"> <br> <br>
Re-enter Password:&nbsp;<input type="password" name="pw" id="pw2"> <br> <br>
<script>
if(document.getElementById("pw1").value!=document.getElementById("pw2").value)
	alert("Password Not Matched.Re-enter the password!");
</script>
Admission No:&nbsp;<input type="number"> <br> <br>
Batch:&nbsp;<input type="number" placeholder="Year Of Passing"> <br> <br>
Course:&nbsp;<input type="text" > <br> <br>
Additional Qualification: <br>
<textarea rows="5" cols="50" name="description" placeholder="Enter Qualification.."></textarea> <br><br><br>

Address: <br>
	&nbsp;&nbsp;&nbsp;&ensp; Quarter No:<input type="text"> <br><br>
	&nbsp;&nbsp;&nbsp;&ensp; City:<input type="text"> <br><br>
	&nbsp;&nbsp;&nbsp;&ensp; State: <input type="text"> <br><br>
	&nbsp; &nbsp;&nbsp;&ensp;Pin Code: <input type="number"> <br><br> 
	&nbsp; &nbsp;&nbsp;&ensp;Country: <input type="text"> <br> <br><br>
	
Occupation:&nbsp;<input type="text"> <br><br>
Designation:&nbsp;<input type="text"> <br> <br><br>
Company Name:&nbsp;<input type="text"><br><br>
Company Address:&nbsp;<input type="text"> <br> <br><br> 
                ...
                <ul class="list-unstyled contact-info list">
                  <li>
                    <div class="unit unit-horizontal unit-middle unit-spacing-xs">
                      ...
                      <div class="unit-body"><a href="callto:#" class="text-dark">+91 11 24113436</a>
                      </div>
                    </div>
                  </li>
...
<img class="olark-image-modal" src="./Reg.jsp" data-reactid=".0.4.1.0"></span>
</div></div></div>
<!-- Google Tag Manager -->
