...
<h3><strong> ENTER LOGIN DETAILS </strong> </h3> <br>
...
<c:out value="${output}" escapeXml="false"></c:out> <br>
<c:out value="${uname}" escapeXml="false"></c:out> <br>
<c:out value="${pwd}" escapeXml="false"></c:out> <br>

</div>

<h4> Not Registered? </h4>
<p> <a href="Reg.jsp"><h5 style="color:blue"><u>Register</u></h5></a> </p> 
...
<img class="olark-image-modal" src="./login-register.jsp" data-reactid=".0.4.1.0"></span>
</div></div></div>
<!-- Google Tag Manager -->
